...
class SpeechTxt extends StatefulWidget {
  SpeechTxt({Key? key}) : super(key: key);

  @override
  SpeechTxtState createState() => SpeechTxtState();
}

class SpeechTxtState extends State<SpeechTxt> {
  ...
  Future<void> _extractTextFromSpecificPage(int page) async {
    PdfDocument document =
        PdfDocument(inputBytes: await _readDocumentData('e2.pdf'));
